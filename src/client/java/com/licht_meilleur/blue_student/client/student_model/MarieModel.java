...
public class MarieModel extends GeoModel<MarieEntity> {

    @Override
    public Identifier getModelResource(MarieEntity animatable) {
        return new Identifier(BlueStudentMod.MOD_ID, "geo/marie.geo.json");
    }

    @Override
    public Identifier getTextureResource(MarieEntity animatable) {
        return new Identifier(BlueStudentMod.MOD_ID, "textures/entity/marie.png");
    }

    @Override
    public Identifier getAnimationResource(MarieEntity animatable) {
        return new Identifier(BlueStudentMod.MOD_ID, "animations/marie.animation.json");
    }

    @Override
    public void setCustomAnimations(MarieEntity animatable, long instanceId, AnimationState<MarieEntity> animationState) {
