...
public class NozomiModel extends GeoModel<NozomiEntity> {

    @Override
    public Identifier getModelResource(NozomiEntity animatable) {
        return new Identifier(BlueStudentMod.MOD_ID, "geo/nozomi.geo.json");
    }

    @Override
    public Identifier getTextureResource(NozomiEntity animatable) {
        return new Identifier(BlueStudentMod.MOD_ID, "textures/entity/nozomi.png");
    }

    @Override
    public Identifier getAnimationResource(NozomiEntity animatable) {
        return new Identifier(BlueStudentMod.MOD_ID, "animations/nozomi.animation.json");
    }

    @Override
    public void setCustomAnimations(NozomiEntity animatable, long instanceId, AnimationState<NozomiEntity> animationState) {
