...
public class HikariModel extends GeoModel<HikariEntity> {

    @Override
    public Identifier getModelResource(HikariEntity animatable) {
        return new Identifier(BlueStudentMod.MOD_ID, "geo/hikari.geo.json");
    }

    @Override
    public Identifier getTextureResource(HikariEntity animatable) {
        return new Identifier(BlueStudentMod.MOD_ID, "textures/entity/hikari.png");
    }

    @Override
    public Identifier getAnimationResource(HikariEntity animatable) {
        return new Identifier(BlueStudentMod.MOD_ID, "animations/hikari.animation.json");
    }

    @Override
    public void setCustomAnimations(HikariEntity animatable, long instanceId, AnimationState<HikariEntity> animationState) {
